...
def plot_metric(tag, title, ylabel, runs_data):
    """Plot a single metric comparing all seeds."""
...
def main():
    ...
    # ── Bonus: mean ± std band plot for total reward ──────────────────────────
