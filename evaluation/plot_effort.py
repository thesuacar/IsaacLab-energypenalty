...
RUNS = {
    ...
    "Seed 789": "jointeffort789",
    "Seed 999": "jointeffort999"
}
...
def plot_metric(tag, title, ylabel, runs_data):
    ...
    ax.set_title(f"Config 2 (Joint Effort) — {title}", fontsize=14, fontweight="bold")
...
def main():
    ...
    if len(all_values) > 1:
        ...
        ax.set_title("Config 2 (Joint Effort) — Total Reward (Mean ± Std, 3 Seeds)",
