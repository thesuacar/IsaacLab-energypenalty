...
This repository is a fork of [isaac-sim/IsaacLab](https://github.com/isaac-sim/IsaacLab) extended with energy-aware reward shaping for robotic grasping research. It trains a **Franka Emika Panda** arm using **Proximal Policy Optimization (PPO)** and compares three reward configurations that progressively introduce energy-consumption penalties derived from joint torque and motion smoothness (acceleration).

WARNING: this branch (thesis) is made exclusively for the thesis coding submission. IsaacLab is a large library of interconnected modules; on this branch, the author guarantees clarity of authorship and representativeness of methods, but not full reproducibility. To reproduce the experiments, please use main: https://github.com/thesuacar/IsaacLab-energypenalty
